...
pq:
	dmd -m64 doc2.d latex.d jstex.d comment.d stemmer.d dom.d script.d jsvar.d color.d -version=with_postgres database.d postgres.d -L-L/usr/local/pgsql/lib -L-lpq -J. $(LIBDPARSE) -g # -version=std_parser_verbose 
locate:
