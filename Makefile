...
all:
	...
	dmd -m64 doc2.d latex.d comment.d stemmer.d dom.d script.d jsvar.d color.d -J. $(LIBDPARSE) -g # -version=std_parser_verbose 
...
ldc:
	ldc2 -oq -O3 -m64 doc2.d latex.d comment.d stemmer.d dom.d color.d -J. $(LIBDPARSE) -g # -version=std_parser_verbose 

http:
	dmd -debug -ofserver -version=embedded_httpd -version=with_http_server -m64 doc2.d latex.d cgi.d comment.d stemmer.d dom.d script.d jsvar.d color.d -J. $(LIBDPARSE) -g # -version=std_parser_verbose 
