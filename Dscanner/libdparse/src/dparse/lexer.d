...
private pure nothrow @safe:
    ...
    void lexIstringPlain(ref Token token)
    {
	    ...
	    // import std.stdio; debug writeln("byte ", c, " ", istringStack[$ - 1].type == IstringState.Type.tokenString, " ", istringStack[$ - 1].braces);
            switch (c)
            {
            case '\\':
		    ...
		    // FIXME: really should be doing more like what lexTokenString does
